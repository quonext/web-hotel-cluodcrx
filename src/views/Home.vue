    ...
    <header>
      ...
      <div class="header-content">
        <div class="header-fondo">
          <div
            class="carousel slide carouselBg"
            id="carouselBtrg"
            data-ride="carousel"
            data-interval="3000"
          >
            <div class="carousel-inner">
              <div class="item active">
                <div
                  class="img-responsive fondo-img"
                  style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/3b/f3/3bf367792919dd7d594cf58c3ff66b88.jpg&#39;);"
                ></div>
        ...
        <div class="header-extra hidden-xs">
          ...
          <div class="smoke">
            ...
            />
            <span>Espacio libre de humos</span>
          </div>
        </div>
...
">
        ...
        <div class="header-mkc">
          <div class="carousel slide carouselMkc carousel-fade" id="carouselMkc">
            ...
            <ol class="carousel-indicators">
              <li data-target="#carouselMkc" data-slide-to="0" class="active"></li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div id="wrapper">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 item">
            <a href="#" title="GASTRONOMÍA CANARIA">
              <div class="inner">
                ...
                <div class="box-hover">
                  <div class="box-inner">
                    <h4>Platos típicos con un toque creativo</h4>
                    <h5>GASTRONOMÍA CANARIA</h5>
                    <span class="arrow">
                      <img
                        title="GASTRONOMÍA CANARIA  quohotel SELECCIÓN LA PLANTACIÓN DEL SUR Costa Adeje"
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 item">
            <a href="#" title="EVENTOS ÚNICOS">
              <div class="inner">
                ...
                <div class="box-hover">
                  <div class="box-inner">
                    <h4>Frente a la Playa del Duque</h4>
                    <h5>EVENTOS ÚNICOS</h5>
                    <span class="arrow">
                      <img
                        title="EVENTOS ÚNICOS  quohotel SELECCIÓN LA PLANTACIÓN DEL SUR Costa Adeje"
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 item">
            <a href="#" title="HABITACIONES &amp; SUITES">
              <div class="inner">
                ...
                <div class="box-hover">
                  <div class="box-inner">
                    <h4>El descanso durante tus vacaciones</h4>
                    <h5>HABITACIONES &amp; SUITES</h5>
                    <span class="arrow">
                      <img
                        title="HABITACIONES &amp; SUITES  quohotel SELECCIÓN LA PLANTACIÓN DEL SUR Costa Adeje"
      ...
      <div class="list-offers">
        <div class="container">
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 pn">
            <div class="box-offer">
              <div class="inner-foto">
                <div
                  class="img-responsive big-foto"
                  style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/5e/1d/5e1d6790e38cd50f9ed6070f6d005ebe.jpg&#39;);"
                ></div>
                <div class="dark-fondo"></div>
              </div>
              <div class="box-inner">
                ...
                <div class="footer">
                  <button
                    class="btnOfertas btn btn-primario"
          ...
          <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 pn">
            <div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 box-foto">
                ...
                >
                  <div
                    class="img-responsive big-foto hidden-xs hidden-sm"
                    style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/0d/ed/0ded09be85d3797452fd6f1d8a937c6e.jpg&#39;);"
                  ></div>
                </a>
                <div
                  class="img-responsive big-foto hidden-md hidden-lg"
                  style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/0e/a3/0ea3c25efb6b0db99d510facc91d55cd.jpg&#39;);"
                ></div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 box-foto">
                <a
                ...
                >
                  <div
                    class="img-responsive big-foto hidden-xs hidden-sm"
                    style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/cb/34/cb34019bd4dc08d638d8880430d1ae64.jpg&#39;);"
                  ></div>
                </a>
                <div
                  class="img-responsive big-foto hidden-md hidden-lg"
                  style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/39/39/3939c9b49a3354cabbce5c86209cf72e.jpg&#39;);"
                ></div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 box-foto">
                <a
                ...
                >
                  <div
                    class="img-responsive big-foto hidden-xs hidden-sm"
                    style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/83/39/833985dd55bdf72722797cf48c863d0c.jpg&#39;);"
                  ></div>
                </a>
                <div
                  class="img-responsive big-foto hidden-md hidden-lg"
                  style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/fc/5b/fc5b0ffcebf651a5c56da586abba9221.jpg&#39;);"
                ></div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 box-foto">
                <a
                ...
                >
                  <div
                    class="img-responsive big-foto hidden-xs hidden-sm"
                    style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/55/d5/55d55344596baa11925b1c17193fa375.jpg&#39;);"
                  ></div>
                </a>
                <div
                  class="img-responsive big-foto hidden-md hidden-lg"
                  style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/30/1f/301f5c09cbb6182952452bf6055b7fa0.jpg&#39;);"
                ></div>
              </div>
            </div>
          </div>
      ...
      <div class="list-services">
        <div class="container">
          <div class="box-inner">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pn box-foto">
              <div
                class="img-responsive big-foto hidden-xs hidden-sm"
                style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/ca/5b/ca5b04eac9411c7e760b20c7dba7b8cb.jpg&#39;);"
              ></div>
              <div
                class="img-responsive big-foto hidden-md hidden-lg"
                style="background-image: url(&#39;https://www.vinccilaplantaciondelsur.com/cache/6a/fc/6afcaec92fe25a0b3a8f8165fb029337.jpg&#39;);"
              ></div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 pn box-text">
              <div class="inner">
