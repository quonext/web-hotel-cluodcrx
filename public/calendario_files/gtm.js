...
var Y={a:{}};
Y.a.veip=["nonGooglePixels"],function(){var a=!1,b=function(c){if(a)c.vtp_gtmOnSuccess();else if(qj(c.vtp_pixelUrl,["veinteractive.com","ve-interactive.cn"]))try{pj(c.vtp_pixelUrl,c.vtp_gtmOnSuccess,c.vtp_gtmOnFailure),a=!0}catch(d){G(c.vtp_gtmOnFailure)}else G(c.vtp_gtmOnFailure)};Y.__veip=b;Y.__veip.b="veip";Y.__veip.g=!0;Y.__veip.priorityOverride=0}();
...
Y.a.vei=["nonGoogleScripts"],function(){var a=!1,b=function(c){if(a)c.vtp_gtmOnSuccess();else if(qj(c.vtp_jsUrl,["veinteractive.com","ve-interactive.cn"]))try{R(c.vtp_jsUrl,c.vtp_gtmOnSuccess,c.vtp_gtmOnFailure),a=!0}catch(d){G(c.vtp_gtmOnFailure)}else G(c.vtp_gtmOnFailure)};Y.__vei=b;Y.__vei.b="vei";Y.__vei.g=!0;Y.__vei.priorityOverride=0}();
